                                ...
                                ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="proses/proses_penjualan_petugas.php?ProdukID=<?php echo $data['ProdukID'] ?>&PenjualanID=<?php echo $penjualan->idauto('nextID'); ?>&aksi=hapus" class="btn btn-warning">Hapus</a>
                                            </td>
                                        </tr>
