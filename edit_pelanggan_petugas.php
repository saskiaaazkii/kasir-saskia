        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="proses/proses_pelanggan_petugas.php?aksi=update" method="POST">
                            <?php 
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" align="left"><a href="petugas.php?page=pelanggan_petugas" class="btn btn-primary">Back</a>
