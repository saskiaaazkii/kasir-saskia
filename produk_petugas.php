        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="proses/proses_produk_petugas.php?aksi=simpan" method="POST">
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="petugas.php?page=edit_produk_petugas&ProdukID=<?php echo $data['ProdukID'] ?>" class="btn btn-success"> Edit </a> | 
                                            <a href="proses/proses_produk_petugas.php?ProdukID=<?php echo $data['ProdukID'] ?>&aksi=hapus" class="btn btn-warning"> Hapus </a>
                                        </td>
                                    </tr>
                                </tbody>
                            <?php } ?>
